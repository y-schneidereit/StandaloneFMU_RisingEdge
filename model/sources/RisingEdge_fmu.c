...
# define RT_MDL_TYPE      RT_MODEL_RisingEdge_T
#endif
...
modelData->bOutput[0] = *(modelData->bList[1]);
}
void fmu_RestoreOutput() {
    FMUModelData *modelData = (FMUModelData *)_instance;
*(modelData->bList[1]) = modelData->bOutput[0];
}
...
fmi2Component fmi2Instantiate(fmi2String instanceName, fmi2Type fmuType, fmi2String fmuGUID,
    ...
    if (!functions->logger) {
        ...
        return NULL;
    } else if (strcmp(fmuGUID, "{d7bac2e2-f3c4-fc14-357b-41ecbe1c538d}")) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Wrong GUID %s. Expected %s.", fmuGUID, "{d7bac2e2-f3c4-fc14-357b-41ecbe1c538d}");
        return NULL;
    }
    ...
    modelData->bList = (boolean_T**)calloc(2, sizeof(boolean_T*));
    if (!modelData->bList) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Memory allocation error.");
        return NULL;
    }
    modelData->bOutput = (boolean_T*)calloc(1, sizeof(boolean_T));
    ...
    modelData->bList[0] = &(RisingEdge_U.u);
    modelData->bList[1] = &(RisingEdge_Y.T);
